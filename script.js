let lab=label("label","for","clear","enter country name")
br=document.createElement("br")
let inp=createelement("input","type","text","id","clear","entervalue","country name")
let brm=document.createElement("br")
let lab1=label("label","for","clea","result")

let br1=document.createElement("br")
let inp1=createelement("input","type","text","id","clea","entervalue","Active/Recovered/Deaths")
...
//console.log(fin)//https://api.covid19api.com/live/country/
    let esm=await fetch(`https://api.covid19api.com/live/country/${fin}`)
